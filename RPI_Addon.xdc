...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { a }]; #rpio_sd
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { b }]; #rpio_sc 
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { c }]; #rpio_02
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { d }]; #rpio_03
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { e }]; #rpio_04
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { f }]; #rpio_05
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { g }]; #rpio_06
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { dp }]; #rpio_07
...
##Switches##
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { reset }]; #rpio_14
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { start }]; #rpio_15
